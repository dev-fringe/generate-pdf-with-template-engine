...
import dev.fringe.domain.Purchase;
...
public class RandomDataGenerator {
	...
	public static Customer randomCustomer(int id) {
		...
		c.setEmail(FAKER.internet().safeEmailAddress(StringUtils.join(firstName.replaceAll("'", "").toLowerCase(), ".",
	...
	public static Purchase randomPurchase() {
		...
		p.setDate(RandomDataGenerator.randomDateTime(LocalDateTime.of(2012, 01, 01, 0, 0),
